...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function() {
        const longText = 'Testes, teste, teste, teste, teste, teste, teste, teste, teste, teste, teste, teste, teste, teste, teste, teste, teste'
        cy.get('#firstName').type('Rogério')
    ...
    it('exibe mensagem de erro ao submeter o formulário com um email com formatação',function(){
        cy.get('#firstName').type('Rogério')
        cy.get('#lastName').type('Alves')
        cy.get('#email').type('camargo_outlook.com')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone',function() {
        cy.get('#firstName')
        .type('Rogério')
        .should('have.value','Rogério')
        .clear()
        .should('have.value','')
    })

    it('exibe mensagem de erro ao sunmeter o formulário sem preencher is campos obrigatórios', function() {
        cy.contains('button','Enviar').click()
        cy.get('.error').should('be.visible')
